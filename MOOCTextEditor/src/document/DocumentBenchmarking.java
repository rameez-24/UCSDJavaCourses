...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		int start = 50000;
		 ...
		 System.out.println("numOfChars\tbasicDocument\tefficientDocument");
				...
				numToCheck += increment)
		{
			...
			System.out.print((double) ((endBasicTime - startBasicTime)/1000000.00) + "\t");
			...
			System.out.println((double) ((endEfficientTime - startEfficientTime)/1000000.00));
