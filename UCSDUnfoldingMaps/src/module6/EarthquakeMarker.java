...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker> 
{
	...
	public void drawInfo(PGraphics pg, float x, float y) {    
        ...
        pg.fill(0);
        pg.textSize(12);
        pg.text("Title", xbase+20, ybase+20);
        pg.text(getTitle().substring(0,getTitle().length()/2), xbase+20, ybase+40);
        pg.text(getTitle().substring(1+(getTitle().length()/2)), xbase+20, ybase+60);

        pg.fill(0);
        pg.textSize(12);
        pg.text("Magnitude", xbase+20, ybase+80);
        pg.text(getMagnitude(), xbase+20, ybase+100);

        pg.fill(0);
        pg.textSize(12);
        pg.text("Depth", xbase+20, ybase+120);
        pg.text(getDepth(), xbase+20, ybase+140);

        pg.fill(0);
        pg.textSize(12);
        pg.text("Threat Circle", xbase+20, ybase+160);
        pg.text(""+threatCircle(), xbase+20, ybase+180);

        pg.fill(0);
        pg.textSize(12);
        pg.text("Is On Land", xbase+20, ybase+200);
        pg.text(""+isOnLand(), xbase+20, ybase+220);
