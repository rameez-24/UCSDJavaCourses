...
public class CityMarker extends CommonMarker {
	...
	public void drawInfo(PGraphics pg, float x, float y) {    
        ...
        pg.rect(xbase, ybase, 150, 200);
        
        pg.fill(0);
        pg.textSize(12);
        pg.text("City Name", xbase+20, ybase+20);
        pg.text(getCity(), xbase+20, ybase+40);

        pg.fill(0);
        pg.textSize(12);
        pg.text("Country", xbase+20, ybase+80);
        pg.text(getCountry(), xbase+20, ybase+100);

        pg.fill(0);
        pg.textSize(12);
        pg.text("Population", xbase+20, ybase+140);
        pg.text(getPopulation()+" M", xbase+20, ybase+160);
